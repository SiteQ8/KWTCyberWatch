...
(function () {
  ...
  const reportFoot = () => `<p class="muted" style="margin-top:40px">Generated ${esc(new Date().toISOString())} by KWTCyberWatch v${esc(KCW.version)} (browser engine) · analyst ${esc(S.analyst || "—")} · TLP:AMBER</p><p class="muted" style="border-top:1px solid #eee;padding-top:10px">${esc(DISCLAIMER)}</p></body></html>`;
